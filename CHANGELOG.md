...
Date:   2022-10-22
    ...
    #0.2.43
    1. Изменены карточки Storage для организации в соответсвии с требованием ТЗ от 30,09,22
    2. Исправил баг с залипением меню TopNav при переходе с одной страницы на другую
