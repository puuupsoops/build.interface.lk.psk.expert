...
Date:   2022-05-06
    ...
    3. BagFix: при создании нескольких заявок подряд на странице с успехом вместо прилоадера показывал номер заказа прошлой заявки пока создавалась новая заявка.
