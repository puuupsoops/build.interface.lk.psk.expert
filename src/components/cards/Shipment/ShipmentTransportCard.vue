          ...
          <div class="shipment-form-heading shipment-form-wrap">
            <div class="shipment-form-elem">
              <div class="shipment-form-item"> 
                <div class="shipment-form-elem-title"><span>Адрес транспортной</span></div>
                <div class="shipment-form-row">
                  <div class="shipment-form-input-wrap">
                    <div class="shipment-form-input-wrap shipment-datalist" id="shipment-datalist">
                      <input class="shipment-form-input shipment-datalist-input" type="text" value="Россия г. Москва ул. Ангарская вл. 8, стр. 15 д." id="shipment-datalist-input">
                      <ul class="shipment-datalist-list active" id="shipment-datalist-list"><li id="1">Россия г. Москва ул. Ангарская вл. 8, стр. 15 д.</li><li id="2">Россия г. Москва ул. Ангарская вл. 9, стр. 15 д.</li><li id="3">Россия г. Москва ул. Ангарская вл. 10, стр. 15 д.</li><li id="4">Россия г. Москва ул. Ангарская вл. 11, стр. 15 д.</li></ul>
                    </div><a class="shipment-form-map-btn" href=""> 
                      ...
                      </svg><span>На карте</span></a>
                  </div>
                  <div class="shipment-form-btn shipment-form-accept-btn">Подтвердить</div>
                </div>
              </div>
            </div>
            <div class="shipment-form-elem">
              <div class="shipment-form-item">
                ...
                <div class="shipment-form-row">
                  <div class="shipment-form-date">
                    <input class="shipment-form-input shipment-form-date-input hasDatepicker" type="text" placeholder="Выберите дату" name="date" autocomplete="off" id="dp1638346359264">
                  </div>
          ...
          <div class="shipment-form-body shipment-form-wrap">
            <div class="shipment-form-elem">
              <div class="shipment-form-item">
                ...
                <textarea class="shipment-form-textarea" name=""></textarea>
              </div>
            </div>
            <div class="shipment-form-elem">
              <div class="shipment-form-item">
                ...
                <div class="shipment-form-info shipment-form-info-text">
                  <p>Заказ №2435 от 03.04.2020</p>
                  <p>Желаемая дата отгрузки: 05.04.2020</p>
                  <p>Расстояние: 1124 км</p>
                  <p>Количество едениц: 120</p>
                  <p>Общий вес: 25 кг</p>
                  <p>Общий объем: 23 м3 </p>
                  <p>Адрес доставки: Россия г. Москва ул. Ангарская вл. 8, стр. 15 д.</p>
                  <p>Комментрий: Нет</p>
                  <p>Дополнительные условия: Ополечивание</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="shipment-form-elem">
              ...
              <div class="shipment-form-wrap shipment-form-checkbox-box">
                <div class="shipment-form-checkbox-wrap">
                  <input class="shipment-form-checkbox" type="checkbox" id="shipment-checkbox-1">
                  <label class="shipment-form-checkbox-label" for="shipment-checkbox-1">Жесткая упаковка</label>
                </div>
                <div class="shipment-form-checkbox-wrap">
                  <input class="shipment-form-checkbox" type="checkbox" id="shipment-checkbox-2">
