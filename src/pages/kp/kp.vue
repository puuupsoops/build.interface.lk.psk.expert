<template>
    <div class="kp">
        ...
        <div class="kp-head-card">
            <div class="kp-head-card-title">Конструктор коммерческий предложений</div>
            <div class="kp-head-card-subtitle">
                ...
                <div>На этой странице Вы сможете на основании совершенного заказа, черновика или товара сформировать коммерческое предложение со своим логотипом и ценами. Пройдите несколько шагов для того чтобы сохранить КП.</div>
            </div>
        </div>
        <div class="kp-form">
